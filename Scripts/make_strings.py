...
T = {
 ...
 "New Document": {"it":"Nuovo documento","es":"Nuevo documento","fr":"Nouveau document","de":"Neues Dokument","pt-BR":"Novo documento","ja":"新規書類","zh-Hans":"新建文稿"},
 "New Folder": {"it":"Nuova cartella","es":"Nueva carpeta","fr":"Nouveau dossier","de":"Neuer Ordner","pt-BR":"Nova pasta","ja":"新規フォルダ","zh-Hans":"新建文件夹"},
 "Untitled": {"it":"Senza titolo","es":"Sin título","fr":"Sans titre","de":"Ohne Titel","pt-BR":"Sem título","ja":"名称未設定","zh-Hans":"未命名"},
 "Choose a name.": {"it":"Scegli un nome.","es":"Elige un nombre.","fr":"Choisissez un nom.","de":"Wähle einen Namen.","pt-BR":"Escolha um nome.","ja":"名前を選んでください。","zh-Hans":"请选择名称。"},
 "Create": {"it":"Crea","es":"Crear","fr":"Créer","de":"Erstellen","pt-BR":"Criar","ja":"作成","zh-Hans":"创建"},
 "OK": {"it":"OK","es":"Aceptar","fr":"OK","de":"OK","pt-BR":"OK","ja":"OK","zh-Hans":"好"},
 "An item with this name already exists.": {"it":"Esiste già un elemento con questo nome.","es":"Ya existe un elemento con este nombre.","fr":"Un élément portant ce nom existe déjà.","de":"Ein Element mit diesem Namen ist bereits vorhanden.","pt-BR":"Já existe um item com este nome.","ja":"同じ名前の項目がすでに存在します。","zh-Hans":"已存在同名项目。"},
 "Rename…": {"it":"Rinomina…","es":"Renombrar…","fr":"Renommer…","de":"Umbenennen…","pt-BR":"Renomear…","ja":"名前を変更…","zh-Hans":"重新命名…"},
 "Duplicate": {"it":"Duplica","es":"Duplicar","fr":"Dupliquer","de":"Duplizieren","pt-BR":"Duplicar","ja":"複製","zh-Hans":"制作副本"},
 "Move To…": {"it":"Sposta in…","es":"Mover a…","fr":"Déplacer vers…","de":"Bewegen nach…","pt-BR":"Mover para…","ja":"移動先…","zh-Hans":"移动到…"},
 "Move": {"it":"Sposta","es":"Mover","fr":"Déplacer","de":"Bewegen","pt-BR":"Mover","ja":"移動","zh-Hans":"移动"},
 "Move to Trash": {"it":"Sposta nel Cestino","es":"Mover a la papelera","fr":"Placer dans la corbeille","de":"In den Papierkorb legen","pt-BR":"Mover para o Lixo","ja":"ゴミ箱に入れる","zh-Hans":"移到废纸篓"},
 "Choose the destination folder.": {"it":"Scegli la cartella di destinazione.","es":"Elige la carpeta de destino.","fr":"Choisissez le dossier de destination.","de":"Wähle den Zielordner.","pt-BR":"Escolha a pasta de destino.","ja":"移動先のフォルダを選んでください。","zh-Hans":"请选择目标文件夹。"},
 "copy": {"it":"copia","es":"copia","fr":"copie","de":"Kopie","pt-BR":"cópia","ja":"コピー","zh-Hans":"副本"},
 "copy %d": {"it":"copia %d","es":"copia %d","fr":"copie %d","de":"Kopie %d","pt-BR":"cópia %d","ja":"コピー %d","zh-Hans":"副本 %d"},
 ...
 "Open Folder": {"it":"Apri cartella","es":"Abrir carpeta","fr":"Ouvrir le dossier","de":"Ordner öffnen","pt-BR":"Abrir pasta","ja":"フォルダを開く","zh-Hans":"打开文件夹"},
 "Start Page": {"it":"Pagina iniziale","es":"Página de inicio","fr":"Page d’accueil","de":"Startseite","pt-BR":"Página inicial","ja":"スタートページ","zh-Hans":"起始页"},
 ...
 "Promote Heading": {"it":"Alza livello del titolo","es":"Subir nivel del título","fr":"Promouvoir le titre","de":"Überschrift hochstufen","pt-BR":"Elevar nível do título","ja":"見出しレベルを上げる","zh-Hans":"提升标题级别"},
 "Demote Heading": {"it":"Abbassa livello del titolo","es":"Bajar nivel del título","fr":"Rétrograder le titre","de":"Überschrift herabstufen","pt-BR":"Rebaixar nível do título","ja":"見出しレベルを下げる","zh-Hans":"降低标题级别"},
 ...
 "Table": {"it":"Tabella","es":"Tabla","fr":"Tableau","de":"Tabelle","pt-BR":"Tabela","ja":"表","zh-Hans":"表格"},
 "Table…": {"it":"Tabella…","es":"Tabla…","fr":"Tableau…","de":"Tabelle…","pt-BR":"Tabela…","ja":"表…","zh-Hans":"表格…"},
 "Edit Table…": {"it":"Modifica tabella…","es":"Editar tabla…","fr":"Modifier le tableau…","de":"Tabelle bearbeiten…","pt-BR":"Editar tabela…","ja":"表を編集…","zh-Hans":"编辑表格…"},
 "Rows:": {"it":"Righe:","es":"Filas:","fr":"Lignes :","de":"Zeilen:","pt-BR":"Linhas:","ja":"行:","zh-Hans":"行："},
 "Columns:": {"it":"Colonne:","es":"Columnas:","fr":"Colonnes :","de":"Spalten:","pt-BR":"Colunas:","ja":"列:","zh-Hans":"列："},
 "Add Row": {"it":"Aggiungi riga","es":"Añadir fila","fr":"Ajouter une ligne","de":"Zeile hinzufügen","pt-BR":"Adicionar linha","ja":"行を追加","zh-Hans":"添加行"},
 "Add Column": {"it":"Aggiungi colonna","es":"Añadir columna","fr":"Ajouter une colonne","de":"Spalte hinzufügen","pt-BR":"Adicionar coluna","ja":"列を追加","zh-Hans":"添加列"},
 "Remove Row": {"it":"Rimuovi riga","es":"Eliminar fila","fr":"Supprimer la ligne","de":"Zeile entfernen","pt-BR":"Remover linha","ja":"行を削除","zh-Hans":"移除行"},
 "Remove Column": {"it":"Rimuovi colonna","es":"Eliminar columna","fr":"Supprimer la colonne","de":"Spalte entfernen","pt-BR":"Remover coluna","ja":"列を削除","zh-Hans":"移除列"},
 "Remove Row %d": {"it":"Rimuovi riga %d","es":"Eliminar fila %d","fr":"Supprimer la ligne %d","de":"Zeile %d entfernen","pt-BR":"Remover linha %d","ja":"%d行を削除","zh-Hans":"移除第 %d 行"},
 "Remove Column %d": {"it":"Rimuovi colonna %d","es":"Eliminar columna %d","fr":"Supprimer la colonne %d","de":"Spalte %d entfernen","pt-BR":"Remover coluna %d","ja":"列%dを削除","zh-Hans":"移除第 %d 列"},
 "Add Row Below %d": {"it":"Aggiungi riga sotto la riga %d","es":"Añadir fila debajo de la fila %d","fr":"Ajouter une ligne sous la ligne %d","de":"Zeile unter Zeile %d hinzufügen","pt-BR":"Adicionar linha abaixo da linha %d","ja":"%d行の下に追加","zh-Hans":"在第 %d 行下方添加"},
 "Add Column After %d": {"it":"Aggiungi colonna dopo la colonna %d","es":"Añadir columna después de la columna %d","fr":"Ajouter une colonne après la colonne %d","de":"Spalte nach Spalte %d hinzufügen","pt-BR":"Adicionar coluna após a coluna %d","ja":"列%dの後に追加","zh-Hans":"在第 %d 列后添加"},
 "Cancel": {"it":"Annulla","es":"Cancelar","fr":"Annuler","de":"Abbrechen","pt-BR":"Cancelar","ja":"キャンセル","zh-Hans":"取消"},
 "Apply": {"it":"Applica","es":"Aplicar","fr":"Appliquer","de":"Anwenden","pt-BR":"Aplicar","ja":"適用","zh-Hans":"適用"},
 "Column %d": {"it":"Colonna %d","es":"Columna %d","fr":"Colonne %d","de":"Spalte %d","pt-BR":"Coluna %d","ja":"列%d","zh-Hans":"第 %d 列"},
 "Row %d, column %d": {"it":"Riga %d, colonna %d","es":"Fila %d, columna %d","fr":"Ligne %d, colonne %d","de":"Zeile %d, Spalte %d","pt-BR":"Linha %d, coluna %d","ja":"%d行%d列","zh-Hans":"第 %d 行，第 %d 列"},
 ...
 "Open Working Folder in Finder": {"it":"Apri la cartella di lavoro nel Finder","es":"Abrir la carpeta de trabajo en Finder","fr":"Ouvrir le dossier de travail dans le Finder","de":"Arbeitsordner im Finder öffnen","pt-BR":"Abrir a pasta de trabalho no Finder","ja":"作業フォルダをFinderで開く","zh-Hans":"在访达中打开工作文件夹"},
 "Open Working Folder in Claude Cowork": {"it":"Apri la cartella di lavoro in Claude Cowork","es":"Abrir la carpeta de trabajo en Claude Cowork","fr":"Ouvrir le dossier de travail dans Claude Cowork","de":"Arbeitsordner in Claude Cowork öffnen","pt-BR":"Abrir a pasta de trabalho no Claude Cowork","ja":"作業フォルダをClaude Coworkで開く","zh-Hans":"在 Claude Cowork 中打开工作文件夹"},
 "Open in Finder": {"it":"Apri nel Finder","es":"Abrir en Finder","fr":"Ouvrir dans le Finder","de":"Im Finder öffnen","pt-BR":"Abrir no Finder","ja":"Finderで開く","zh-Hans":"在访达中打开"},
 "Open in Claude Cowork": {"it":"Apri in Claude Cowork","es":"Abrir en Claude Cowork","fr":"Ouvrir dans Claude Cowork","de":"In Claude Cowork öffnen","pt-BR":"Abrir no Claude Cowork","ja":"Claude Coworkで開く","zh-Hans":"在 Claude Cowork 中打开"},
 ...
 "Welcome to Aurora": {"it":"Benvenuto in Aurora","es":"Te damos la bienvenida a Aurora","fr":"Bienvenue dans Aurora","de":"Willkommen bei Aurora","pt-BR":"Boas-vindas ao Aurora","ja":"Auroraへようこそ","zh-Hans":"欢迎使用 Aurora"},
 "Choose a folder to start writing, or open one of your favorites.": {"it":"Scegli una cartella per iniziare a scrivere, oppure apri una delle tue preferite.","es":"Elige una carpeta para empezar a escribir o abre una de tus favoritas.","fr":"Choisissez un dossier pour commencer à écrire ou ouvrez l’un de vos favoris.","de":"Wähle einen Ordner, um mit dem Schreiben zu beginnen, oder öffne einen Favoriten.","pt-BR":"Escolha uma pasta para começar a escrever ou abra uma das favoritas.","ja":"書き始めるフォルダを選ぶか、お気に入りを開いてください。","zh-Hans":"选择一个文件夹开始写作，或打开一个收藏夹。"},
 "Add to Favorites": {"it":"Aggiungi alle preferite","es":"Añadir a favoritos","fr":"Ajouter aux favoris","de":"Zu Favoriten hinzufügen","pt-BR":"Adicionar aos favoritos","ja":"お気に入りに追加","zh-Hans":"添加到收藏夹"},
 "Favorite Folders": {"it":"Cartelle preferite","es":"Carpetas favoritas","fr":"Dossiers favoris","de":"Favoritenordner","pt-BR":"Pastas favoritas","ja":"お気に入りのフォルダ","zh-Hans":"收藏文件夹"},
 "Favorites": {"it":"Preferiti","es":"Favoritos","fr":"Favoris","de":"Favoriten","pt-BR":"Favoritos","ja":"お気に入り","zh-Hans":"收藏夹"},
 "No favorite folders. Right-click to add one.": {"it":"Nessuna cartella preferita. Fai clic con il tasto destro per aggiungerne una.","es":"No hay carpetas favoritas. Haz clic con el botón derecho para añadir una.","fr":"Aucun dossier favori. Faites un clic droit pour en ajouter un.","de":"Keine Favoritenordner. Klicke mit der rechten Maustaste, um einen hinzuzufügen.","pt-BR":"Nenhuma pasta favorita. Clique com o botão direito para adicionar uma.","ja":"お気に入りのフォルダはありません。右クリックして追加できます。","zh-Hans":"没有收藏文件夹。右键单击以添加。"},
 "Add Favorite…": {"it":"Aggiungi preferita…","es":"Añadir favorita…","fr":"Ajouter un favori…","de":"Favorit hinzufügen…","pt-BR":"Adicionar favorita…","ja":"お気に入りを追加…","zh-Hans":"添加收藏夹…"},
 "Add": {"it":"Aggiungi","es":"Añadir","fr":"Ajouter","de":"Hinzufügen","pt-BR":"Adicionar","ja":"追加","zh-Hans":"添加"},
 "Back": {"it":"Indietro","es":"Atrás","fr":"Retour","de":"Zurück","pt-BR":"Voltar","ja":"戻る","zh-Hans":"返回"},
 "Remove Favorite": {"it":"Rimuovi preferita","es":"Quitar de favoritos","fr":"Retirer des favoris","de":"Favorit entfernen","pt-BR":"Remover favorita","ja":"お気に入りから削除","zh-Hans":"移除收藏夹"},
 "Save a folder as a favorite to find it here.": {"it":"Salva una cartella tra le preferite per ritrovarla qui.","es":"Guarda una carpeta como favorita para encontrarla aquí.","fr":"Enregistrez un dossier dans vos favoris pour le retrouver ici.","de":"Speichere einen Ordner als Favorit, um ihn hier wiederzufinden.","pt-BR":"Salve uma pasta como favorita para encontrá-la aqui.","ja":"フォルダをお気に入りに保存すると、ここに表示されます。","zh-Hans":"将文件夹保存到收藏夹后，会显示在这里。"},
 "Current folder: %@": {"it":"Cartella attuale: %@","es":"Carpeta actual: %@","fr":"Dossier actuel : %@","de":"Aktueller Ordner: %@","pt-BR":"Pasta atual: %@","ja":"現在のフォルダ: %@","zh-Hans":"当前文件夹：%@"},
 "No folder selected yet.": {"it":"Non hai ancora scelto una cartella.","es":"Aún no has elegido una carpeta.","fr":"Vous n’avez pas encore choisi de dossier.","de":"Du hast noch keinen Ordner ausgewählt.","pt-BR":"Você ainda não escolheu uma pasta.","ja":"まだフォルダが選択されていません。","zh-Hans":"尚未选择文件夹。"},
 "Folder is unavailable": {"it":"La cartella non è disponibile","es":"La carpeta no está disponible","fr":"Le dossier n’est pas disponible","de":"Ordner ist nicht verfügbar","pt-BR":"A pasta não está disponível","ja":"フォルダは利用できません","zh-Hans":"文件夹不可用"},
 "Click to select this folder. Right-click to remove it.": {"it":"Fai clic per scegliere questa cartella. Fai clic con il tasto destro per rimuoverla.","es":"Haz clic para elegir esta carpeta. Haz clic con el botón derecho para quitarla.","fr":"Cliquez pour choisir ce dossier. Faites un clic droit pour le retirer.","de":"Klicke, um diesen Ordner auszuwählen. Klicke mit der rechten Maustaste, um ihn zu entfernen.","pt-BR":"Clique para escolher esta pasta. Clique com o botão direito para removê-la.","ja":"クリックしてこのフォルダを選択します。右クリックで削除します。","zh-Hans":"单击以选择此文件夹。右键单击可移除它。"},
